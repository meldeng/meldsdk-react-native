...
Pod::Spec.new do |s|
  ...
  # 0.8 introduces declared protocol dispatch, shared payment actions and native Stripe execution.
  # An existing 0.7 lock must not keep the legacy resolver behind this wrapper's new contract.
  s.dependency 'MeldSDK', '~> 0.8'
end
